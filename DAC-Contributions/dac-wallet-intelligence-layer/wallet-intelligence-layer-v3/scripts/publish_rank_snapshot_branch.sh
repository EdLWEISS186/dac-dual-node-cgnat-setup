...
echo "[INFO] WIL v3.7.0 compact rank snapshot publisher"
...
git -C "$SNAPSHOT_REPO" commit -q \
  -m "publish: WIL v3.7.0 compact rank snapshot $STAMP"
...
echo
echo "[OK] WIL v3.7.0 compact rank snapshot publisher complete"

...
const INTELLIGENCE_BADGE_VERSION = "DIB-v2.0.1";
...
function buildDynamicIntelligenceBadge(output) {
  ...
  const metadata = {
    ...
    external_url: "https://github.com/EdLWEISS186/dac-dual-node-cgnat-setup/tree/main/DAC-Contributions/dac-wallet-intelligence-layer/wallet-intelligence-layer-v1",
    attributes: [

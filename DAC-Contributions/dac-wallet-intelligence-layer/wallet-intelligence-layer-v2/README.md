...
Two previous Wallet Status test entries are intentionally hidden from the DAC Sender NFT Launchpad UI:
...
The UI filters them out so only the final version is shown.
...
- Added approved v8 DAC logo placement.

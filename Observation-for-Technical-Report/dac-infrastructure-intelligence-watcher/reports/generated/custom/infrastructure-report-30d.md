...
| Overall status counts | DEGRADED: 29, HEALTHY: 32, PARTIAL_OUTAGE: 6 |

## 2. Endpoint Status Counts

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 29, HEALTHY: 32, UNHEALTHY: 6 |
...
|---|---:|---:|---|
| official_public_rpc | 6917.54 ms | 27901.0 ms | FAST: 3, MODERATE: 5, SLOW: 59 |
| explorer_web | 618.27 ms | 1246.0 ms | FAST: 17, MODERATE: 50 |
| primary_explorer_api | 462.81 ms | 1157.0 ms | FAST: 38, MODERATE: 29 |

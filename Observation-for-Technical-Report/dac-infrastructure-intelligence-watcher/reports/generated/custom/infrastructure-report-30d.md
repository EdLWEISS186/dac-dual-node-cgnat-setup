...
| Overall status counts | DEGRADED: 22, HEALTHY: 24, PARTIAL_OUTAGE: 6 |

## 2. Endpoint Status Counts

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 22, HEALTHY: 24, UNHEALTHY: 6 |
...
|---|---:|---:|---|
| official_public_rpc | 7970.33 ms | 27901.0 ms | FAST: 3, MODERATE: 5, SLOW: 44 |
| explorer_web | 634.35 ms | 1246.0 ms | FAST: 10, MODERATE: 42 |
| primary_explorer_api | 480.42 ms | 1157.0 ms | FAST: 26, MODERATE: 26 |

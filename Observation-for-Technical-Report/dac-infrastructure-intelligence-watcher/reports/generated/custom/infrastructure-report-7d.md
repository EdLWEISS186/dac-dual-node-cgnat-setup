...
| Snapshot count | 15 |
| First snapshot | 2026-06-19T13-33-33-772138+00-00-health.json |
...
| Overall status counts | DEGRADED: 6, HEALTHY: 6, PARTIAL_OUTAGE: 3 |

## 2. Endpoint Status Counts

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 6, HEALTHY: 6, UNHEALTHY: 3 |
...
|---|---:|---:|---|
| official_public_rpc | 10539.73 ms | 27011.0 ms | FAST: 1, MODERATE: 1, SLOW: 13 |
| explorer_web | 622.73 ms | 1016.0 ms | FAST: 4, MODERATE: 11 |
| primary_explorer_api | 494.2 ms | 942.0 ms | FAST: 6, MODERATE: 9 |

...
| Snapshot count | 23 |
| First snapshot | 2026-06-07T10-41-05-109781+00-00-health.json |
| Latest snapshot | 2026-06-14T07-17-43-721261+00-00-health.json |
| First checked at UTC | 2026-06-07T10:41:05.109781+00:00 |
| Latest checked at UTC | 2026-06-14T07:17:43.721261+00:00 |
| Overall status counts | DEGRADED: 9, HEALTHY: 12, PARTIAL_OUTAGE: 2 |

## 2. Endpoint Status Counts

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 9, HEALTHY: 12, UNHEALTHY: 2 |
| explorer_web | HEALTHY: 23 |
| primary_explorer_api | HEALTHY: 23 |

## 3. Response-Time Summary

| Endpoint | Average response | Max response | Response class counts |
|---|---:|---:|---|
| official_public_rpc | 2742.48 ms | 15388.0 ms | FAST: 2, MODERATE: 1, SLOW: 20 |
| explorer_web | 594.57 ms | 841.0 ms | FAST: 8, MODERATE: 15 |
| primary_explorer_api | 443.57 ms | 1157.0 ms | FAST: 17, MODERATE: 6 |

...
| Overall status counts | DEGRADED: 8, HEALTHY: 7, PARTIAL_OUTAGE: 3 |

## 2. Endpoint Status Counts

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 8, HEALTHY: 7, UNHEALTHY: 3 |
...
|---|---:|---:|---|
| official_public_rpc | 11846.11 ms | 27011.0 ms | SLOW: 18 |
| explorer_web | 623.11 ms | 1016.0 ms | FAST: 4, MODERATE: 14 |
| primary_explorer_api | 483.94 ms | 942.0 ms | FAST: 8, MODERATE: 10 |

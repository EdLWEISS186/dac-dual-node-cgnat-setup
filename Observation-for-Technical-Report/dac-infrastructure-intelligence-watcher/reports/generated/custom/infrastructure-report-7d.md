...
| Snapshot count | 2 |
| First snapshot | 2026-07-06T16-44-58-068005+00-00-health.json |
...
|---|---|
| official_public_rpc | DEGRADED: 1, HEALTHY: 1 |
| explorer_web | HEALTHY: 2 |
| primary_explorer_api | HEALTHY: 2 |

## 3. Response-Time Summary

| Endpoint | Average response | Max response | Response class counts |
|---|---:|---:|---|
| official_public_rpc | 11344.5 ms | 17038.0 ms | SLOW: 2 |
| explorer_web | 576.0 ms | 684.0 ms | FAST: 1, MODERATE: 1 |
| primary_explorer_api | 501.0 ms | 604.0 ms | FAST: 1, MODERATE: 1 |

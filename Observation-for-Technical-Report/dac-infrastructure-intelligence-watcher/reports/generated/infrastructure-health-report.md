...
Generated from latest watcher state UTC: **2026-06-25T07:53:39.662511+00:00**
...
| Checked at UTC | 2026-06-25T07:53:39.662511+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe6006f |
| Latest block decimal | 15073391 |
| Average response time | 17000 ms |
| Maximum response time | 25009 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe6006f | N/A |
...
| Response time | 611 ms | avg=482 ms, max=486 ms |
...
| Latest snapshot | 2026-06-25T07-53-39-662511+00-00-health.json |
| Overall status counts | DEGRADED: 24, HEALTHY: 27, PARTIAL_OUTAGE: 9 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 24, HEALTHY: 27, UNHEALTHY: 9 |
| explorer_web | HEALTHY: 60 |
| primary_explorer_api | HEALTHY: 60 |

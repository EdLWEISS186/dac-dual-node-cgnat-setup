...
Generated from latest watcher state UTC: **2026-06-19T05:22:45.224068+00:00**
...
| Checked at UTC | 2026-06-19T05:22:45.224068+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe5770b |
| Latest block decimal | 15038219 |
| Average response time | 1197 ms |
| Maximum response time | 1368 ms |
| Response class | MODERATE |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe5770b | N/A |
...
| Response time | 602 ms | avg=460 ms, max=473 ms |
...
| Latest snapshot | 2026-06-19T05-22-45-224068+00-00-health.json |
| Overall status counts | DEGRADED: 19, HEALTHY: 22, PARTIAL_OUTAGE: 8 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 19, HEALTHY: 22, UNHEALTHY: 8 |
| explorer_web | HEALTHY: 49 |
| primary_explorer_api | HEALTHY: 49 |

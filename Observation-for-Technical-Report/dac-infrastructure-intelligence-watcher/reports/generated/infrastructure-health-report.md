...
Generated from latest watcher state UTC: **2026-06-10T16:06:33.205459+00:00**
...
| Checked at UTC | 2026-06-10T16:06:33.205459+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe4b672 |
| Latest block decimal | 14988914 |
| Average response time | 2698 ms |
| Maximum response time | 3666 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe4b672 | N/A |
...
| Response time | 401 ms | avg=320 ms, max=322 ms |
...
| Latest snapshot | 2026-06-10T16-06-33-205459+00-00-health.json |
| Overall status counts | DEGRADED: 12, HEALTHY: 13, PARTIAL_OUTAGE: 5 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 12, HEALTHY: 13, UNHEALTHY: 5 |
| explorer_web | HEALTHY: 30 |
| primary_explorer_api | HEALTHY: 30 |

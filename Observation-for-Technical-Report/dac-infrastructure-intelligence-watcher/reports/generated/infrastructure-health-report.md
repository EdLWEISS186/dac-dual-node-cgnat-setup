...
Generated from latest watcher state UTC: **2026-06-28T17:06:35.887276+00:00**
...
| Checked at UTC | 2026-06-28T17:06:35.887276+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe64c8e |
| Latest block decimal | 15092878 |
| Average response time | 8333 ms |
| Maximum response time | 16914 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe64c8e | N/A |
...
| Response time | 624 ms | avg=484 ms, max=539 ms |
...
| Latest snapshot | 2026-06-28T14-43-06-952490+00-00-health.json |
| Overall status counts | DEGRADED: 32, HEALTHY: 35, PARTIAL_OUTAGE: 11 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 32, HEALTHY: 35, UNHEALTHY: 11 |
| explorer_web | HEALTHY: 78 |
| primary_explorer_api | HEALTHY: 78 |

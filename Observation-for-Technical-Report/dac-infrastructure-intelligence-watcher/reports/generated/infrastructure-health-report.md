...
Generated from latest watcher state UTC: **2026-06-27T19:57:07.933682+00:00**
...
| Checked at UTC | 2026-06-27T19:57:07.933682+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe638b9 |
| Latest block decimal | 15087801 |
| Average response time | 21498 ms |
| Maximum response time | 27901 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe638b9 | N/A |
...
| Response time | 622 ms | avg=528 ms, max=557 ms |
...
| Latest snapshot | 2026-06-27T19-57-07-933682+00-00-health.json |
| Overall status counts | DEGRADED: 30, HEALTHY: 32, PARTIAL_OUTAGE: 11 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 30, HEALTHY: 32, UNHEALTHY: 11 |

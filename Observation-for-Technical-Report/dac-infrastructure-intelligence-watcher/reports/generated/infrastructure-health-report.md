...
Generated from latest watcher state UTC: **2026-06-14T07:17:43.721261+00:00**
...
| Checked at UTC | 2026-06-14T07:17:43.721261+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe50006 |
| Latest block decimal | 15007750 |
| Average response time | 2065 ms |
| Maximum response time | 2885 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe50006 | N/A |
...
| Response time | 616 ms | avg=494 ms, max=582 ms |
...
| Overall status counts | DEGRADED: 15, HEALTHY: 18, PARTIAL_OUTAGE: 7 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 15, HEALTHY: 18, UNHEALTHY: 7 |
| explorer_web | HEALTHY: 40 |
| primary_explorer_api | HEALTHY: 40 |

...
| Overall status counts | DEGRADED: 34, HEALTHY: 36, PARTIAL_OUTAGE: 11 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 34, HEALTHY: 36, UNHEALTHY: 11 |
| explorer_web | HEALTHY: 81 |
| primary_explorer_api | HEALTHY: 81 |

...
Generated from latest watcher state UTC: **2026-06-20T23:41:56.110651+00:00**
...
| Checked at UTC | 2026-06-20T23:41:56.110651+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe59f3c |
| Latest block decimal | 15048508 |
| Average response time | 6496 ms |
| Maximum response time | 14011 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe59f3c | N/A |
...
| Response time | 544 ms | avg=520 ms, max=528 ms |
...
| Latest snapshot | 2026-06-19T16-20-47-830658+00-00-health.json |
| Overall status counts | DEGRADED: 20, HEALTHY: 23, PARTIAL_OUTAGE: 8 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 20, HEALTHY: 23, UNHEALTHY: 8 |
| explorer_web | HEALTHY: 51 |
| primary_explorer_api | HEALTHY: 51 |

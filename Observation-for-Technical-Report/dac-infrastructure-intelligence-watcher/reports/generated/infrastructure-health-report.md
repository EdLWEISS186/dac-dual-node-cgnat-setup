...
| Overall status counts | DEGRADED: 24, HEALTHY: 27, PARTIAL_OUTAGE: 10 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 24, HEALTHY: 27, UNHEALTHY: 10 |
| explorer_web | HEALTHY: 61 |
| primary_explorer_api | HEALTHY: 61 |

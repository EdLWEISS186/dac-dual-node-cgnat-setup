...
Generated from latest watcher state UTC: **2026-06-08T20:34:31.713409+00:00**
...
| Checked at UTC | 2026-06-08T20:34:31.713409+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe48e4f |
| Latest block decimal | 14978639 |
| Average response time | 2330 ms |
| Maximum response time | 3903 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe48e4f | N/A |
...
| Response time | 468 ms | avg=522 ms, max=665 ms |
| Response class | FAST | MODERATE |
...
| Latest snapshot | 2026-06-08T06-47-13-271825+00-00-health.json |
| Overall status counts | DEGRADED: 8, HEALTHY: 9, PARTIAL_OUTAGE: 5 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 8, HEALTHY: 9, UNHEALTHY: 5 |

...
Generated from latest watcher state UTC: **2026-06-22T05:28:37.402350+00:00**
...
| Checked at UTC | 2026-06-22T05:28:37.402350+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe5bb27 |
| Latest block decimal | 15055655 |
| Average response time | 17290 ms |
| Maximum response time | 22344 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe5bb27 | N/A |
...
| Response time | 785 ms | avg=770 ms, max=968 ms |
...
| Overall status counts | DEGRADED: 21, HEALTHY: 24, PARTIAL_OUTAGE: 8 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 21, HEALTHY: 24, UNHEALTHY: 8 |
| explorer_web | HEALTHY: 53 |
| primary_explorer_api | HEALTHY: 53 |

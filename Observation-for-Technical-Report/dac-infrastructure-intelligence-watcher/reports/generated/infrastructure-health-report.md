...
Generated from latest watcher state UTC: **2026-06-07T21:02:03.646839+00:00**
...
| Checked at UTC | 2026-06-07T21:02:03.646839+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe4783c |
| Latest block decimal | 14972988 |
| Average response time | 4207 ms |
| Maximum response time | 10288 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe4783c | N/A |
...
| Response time | 423 ms | avg=366 ms, max=381 ms |
...
| Latest snapshot | 2026-06-07T17-06-43-581492+00-00-health.json |
| Overall status counts | DEGRADED: 7, HEALTHY: 8, PARTIAL_OUTAGE: 5 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 7, HEALTHY: 8, UNHEALTHY: 5 |

...
Generated from latest watcher state UTC: **2026-07-11T07:08:38.860026+00:00**
...
| Checked at UTC | 2026-07-11T07:08:38.860026+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe767b2 |
| Latest block decimal | 15165362 |
| Average response time | 2053 ms |
| Maximum response time | 2685 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe767b2 | N/A |
| web3_clientVersion | True | 200 | gdacnode/DAC Testnet RPC 03/v1.11.6-stable/linux-amd64/go1.22.12 | N/A |
...
| Response time | 518 ms | avg=385 ms, max=420 ms |
...
| Overall status counts | DEGRADED: 35, HEALTHY: 38, PARTIAL_OUTAGE: 11 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 35, HEALTHY: 38, UNHEALTHY: 11 |
| explorer_web | HEALTHY: 84 |
| primary_explorer_api | HEALTHY: 84 |
...
| 83 | 2026-07-06T16-44-58-068005+00-00-health.json | DEGRADED | DEGRADED | HEALTHY | HEALTHY |
| 84 | 2026-07-06T18-32-00-687312+00-00-health.json | HEALTHY | HEALTHY | HEALTHY | HEALTHY |

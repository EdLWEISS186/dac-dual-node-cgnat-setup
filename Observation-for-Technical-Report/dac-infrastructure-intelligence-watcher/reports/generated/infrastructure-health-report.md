...
Generated from latest watcher state UTC: **2026-06-27T23:15:29.691261+00:00**
...
| Checked at UTC | 2026-06-27T23:15:29.691261+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe63bd1 |
| Latest block decimal | 15088593 |
| Average response time | 1303 ms |
| Maximum response time | 1618 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe63bd1 | N/A |
...
| Response time | 578 ms | avg=544 ms, max=614 ms |
...
| Latest snapshot | 2026-06-27T20-59-11-427839+00-00-health.json |
| Overall status counts | DEGRADED: 30, HEALTHY: 33, PARTIAL_OUTAGE: 11 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 30, HEALTHY: 33, UNHEALTHY: 11 |
| explorer_web | HEALTHY: 74 |
| primary_explorer_api | HEALTHY: 74 |

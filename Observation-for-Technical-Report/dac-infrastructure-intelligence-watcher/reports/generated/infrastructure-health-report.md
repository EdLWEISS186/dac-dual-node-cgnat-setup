...
Generated from latest watcher state UTC: **2026-06-26T00:04:14.612899+00:00**
...
| Checked at UTC | 2026-06-26T00:04:14.612899+00:00 |
...
| Chain ID | 21894 |
| Chain ID hex | 0x5586 |
| Latest block hex | 0xe60f99 |
| Latest block decimal | 15077273 |
| Average response time | 16596 ms |
| Maximum response time | 21915 ms |
| Response class | SLOW |

| Method | OK | HTTP Status | Result | Error |
|---|---:|---:|---|---|
| eth_chainId | True | 200 | 0x5586 | N/A |
| eth_blockNumber | True | 200 | 0xe60f99 | N/A |
...
| Response time | 469 ms | avg=356 ms, max=374 ms |
...
| Latest snapshot | 2026-06-25T19-29-25-516852+00-00-health.json |
| Overall status counts | DEGRADED: 25, HEALTHY: 28, PARTIAL_OUTAGE: 10 |

| Endpoint | Status counts |
|---|---|
| official_public_rpc | DEGRADED: 25, HEALTHY: 28, UNHEALTHY: 10 |
| explorer_web | HEALTHY: 63 |
| primary_explorer_api | HEALTHY: 63 |

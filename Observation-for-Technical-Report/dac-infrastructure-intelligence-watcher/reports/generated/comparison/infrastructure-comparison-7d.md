...
|---|---|
| Snapshot count | 6 |
| Observation index range | 35 -> 40 |
| First checked at UTC | 2026-06-13T10:43:09.685105+00:00 |
| Latest checked at UTC | 2026-06-14T07:17:43.721261+00:00 |
| Overall status counts | DEGRADED: 1, HEALTHY: 3, PARTIAL_OUTAGE: 2 |
| Availability score | 0.6583 |
...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 1, HEALTHY: 3, UNHEALTHY: 2 | DEGRADED: 3, HEALTHY: 3, UNHEALTHY: 1 | 1385.5 ms | 6284.29 ms | WORSENED |
| explorer_web | HEALTHY: 6 | HEALTHY: 7 | 691.17 ms | 677.86 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 6 | HEALTHY: 7 | 554.33 ms | 476.57 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | FAST: 2, MODERATE: 1, SLOW: 3 | MODERATE: 2, SLOW: 5 | 3548.0 ms | 20946.0 ms |
| explorer_web | MODERATE: 6 | FAST: 2, MODERATE: 5 | 825.0 ms | 1246.0 ms |
| primary_explorer_api | FAST: 3, MODERATE: 3 | FAST: 3, MODERATE: 4 | 1157.0 ms | 703.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.6583 to 0.6929: IMPROVED.
- Official Public RPC average response changed from 1385.5 ms to 6284.29 ms: WORSENED.
- Explorer Web average response changed from 691.17 ms to 677.86 ms: IMPROVED.
- Primary Explorer API average response changed from 554.33 ms to 476.57 ms: IMPROVED.

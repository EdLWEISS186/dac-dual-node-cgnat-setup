...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 3, HEALTHY: 4, UNHEALTHY: 1 | DEGRADED: 4, HEALTHY: 2, UNHEALTHY: 2 | 6644.38 ms | 15354.0 ms | WORSENED |
| explorer_web | HEALTHY: 8 | HEALTHY: 8 | 665.12 ms | 564.5 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 8 | HEALTHY: 8 | 537.5 ms | 434.88 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | FAST: 1, MODERATE: 1, SLOW: 6 | SLOW: 8 | 23841.0 ms | 27011.0 ms |
| explorer_web | FAST: 2, MODERATE: 6 | FAST: 3, MODERATE: 5 | 1016.0 ms | 651.0 ms |
| primary_explorer_api | FAST: 2, MODERATE: 6 | FAST: 5, MODERATE: 3 | 942.0 ms | 511.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.7313 to 0.575: WORSENED.
- Official Public RPC average response changed from 6644.38 ms to 15354.0 ms: WORSENED.
- Explorer Web average response changed from 665.12 ms to 564.5 ms: IMPROVED.
- Primary Explorer API average response changed from 537.5 ms to 434.88 ms: IMPROVED.

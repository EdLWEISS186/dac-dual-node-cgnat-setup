...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 4, HEALTHY: 4, UNHEALTHY: 1 | DEGRADED: 4, HEALTHY: 4, UNHEALTHY: 2 | 10364.89 ms | 13083.3 ms | WORSENED |
| explorer_web | HEALTHY: 9 | HEALTHY: 10 | 648.78 ms | 601.8 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 9 | HEALTHY: 10 | 505.89 ms | 471.2 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | SLOW: 9 | SLOW: 10 | 25009.0 ms | 27011.0 ms |
| explorer_web | FAST: 3, MODERATE: 6 | FAST: 1, MODERATE: 9 | 1016.0 ms | 722.0 ms |
| primary_explorer_api | FAST: 4, MODERATE: 5 | FAST: 4, MODERATE: 6 | 942.0 ms | 612.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.7111 to 0.66: WORSENED.
- Official Public RPC average response changed from 10364.89 ms to 13083.3 ms: WORSENED.
- Explorer Web average response changed from 648.78 ms to 601.8 ms: IMPROVED.
- Primary Explorer API average response changed from 505.89 ms to 471.2 ms: IMPROVED.

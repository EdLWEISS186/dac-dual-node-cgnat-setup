...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 6, HEALTHY: 6 | DEGRADED: 4, HEALTHY: 6, UNHEALTHY: 2 | 3064.5 ms | 2371.42 ms | IMPROVED |
| explorer_web | HEALTHY: 12 | HEALTHY: 12 | 603.67 ms | 589.25 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 12 | HEALTHY: 12 | 426.0 ms | 465.17 ms | WORSENED |
...
|---|---|---|---:|---:|
| official_public_rpc | SLOW: 12 | FAST: 2, MODERATE: 1, SLOW: 9 | 15388.0 ms | 15336.0 ms |
| explorer_web | FAST: 4, MODERATE: 8 | FAST: 4, MODERATE: 8 | 841.0 ms | 825.0 ms |
| primary_explorer_api | FAST: 9, MODERATE: 3 | FAST: 9, MODERATE: 3 | 544.0 ms | 1157.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.775 to 0.7167: WORSENED.
- Official Public RPC average response changed from 3064.5 ms to 2371.42 ms: IMPROVED.
- Explorer Web average response changed from 603.67 ms to 589.25 ms: IMPROVED.
- Primary Explorer API average response changed from 426.0 ms to 465.17 ms: WORSENED.

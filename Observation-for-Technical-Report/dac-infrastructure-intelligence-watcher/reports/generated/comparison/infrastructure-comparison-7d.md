...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 3, HEALTHY: 3, UNHEALTHY: 1 | DEGRADED: 3, HEALTHY: 3, UNHEALTHY: 2 | 7002.71 ms | 13634.62 ms | WORSENED |
| explorer_web | HEALTHY: 7 | HEALTHY: 8 | 695.0 ms | 559.5 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 7 | HEALTHY: 8 | 558.14 ms | 438.25 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | FAST: 1, MODERATE: 1, SLOW: 5 | SLOW: 8 | 23841.0 ms | 27011.0 ms |
| explorer_web | FAST: 1, MODERATE: 6 | FAST: 3, MODERATE: 5 | 1016.0 ms | 651.0 ms |
| primary_explorer_api | FAST: 1, MODERATE: 6 | FAST: 5, MODERATE: 3 | 942.0 ms | 511.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.6929 to 0.6313: WORSENED.
- Official Public RPC average response changed from 7002.71 ms to 13634.62 ms: WORSENED.
- Explorer Web average response changed from 695.0 ms to 559.5 ms: IMPROVED.
- Primary Explorer API average response changed from 558.14 ms to 438.25 ms: IMPROVED.

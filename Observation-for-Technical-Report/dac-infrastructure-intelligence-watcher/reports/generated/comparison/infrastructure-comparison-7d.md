...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 1, HEALTHY: 3, UNHEALTHY: 2 | DEGRADED: 3, HEALTHY: 2, UNHEALTHY: 1 | 1385.5 ms | 5719.33 ms | WORSENED |
| explorer_web | HEALTHY: 6 | HEALTHY: 6 | 691.17 ms | 695.33 ms | WORSENED |
| primary_explorer_api | HEALTHY: 6 | HEALTHY: 6 | 554.33 ms | 488.5 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | FAST: 2, MODERATE: 1, SLOW: 3 | MODERATE: 2, SLOW: 4 | 3548.0 ms | 20946.0 ms |
| explorer_web | MODERATE: 6 | FAST: 2, MODERATE: 4 | 825.0 ms | 1246.0 ms |
| primary_explorer_api | FAST: 3, MODERATE: 3 | FAST: 2, MODERATE: 4 | 1157.0 ms | 703.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.6583 to 0.6417: WORSENED.
- Official Public RPC average response changed from 1385.5 ms to 5719.33 ms: WORSENED.
- Explorer Web average response changed from 691.17 ms to 695.33 ms: WORSENED.
- Primary Explorer API average response changed from 554.33 ms to 488.5 ms: IMPROVED.

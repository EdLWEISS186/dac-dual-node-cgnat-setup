...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 2, HEALTHY: 2, UNHEALTHY: 3 | DEGRADED: 2, HEALTHY: 3, UNHEALTHY: 2 | N/A ms | 2096.75 ms | N/A |
| explorer_web | HEALTHY: 7 | HEALTHY: 7 | 1491.43 ms | 808.0 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 7 | HEALTHY: 7 | N/A ms | 523.5 ms | N/A |
...
|---|---|---|---:|---:|
| official_public_rpc | UNKNOWN: 7 | MODERATE: 2, SLOW: 2, UNKNOWN: 3 | N/A ms | 5347.0 ms |
| explorer_web | UNKNOWN: 7 | MODERATE: 4, UNKNOWN: 3 | 2299.0 ms | 1012.0 ms |
| primary_explorer_api | UNKNOWN: 7 | FAST: 1, MODERATE: 3, UNKNOWN: 3 | N/A ms | 620.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.5286 to 0.6429: IMPROVED.
- Official Public RPC average response changed from N/A ms to 2096.75 ms: N/A.
- Explorer Web average response changed from 1491.43 ms to 808.0 ms: IMPROVED.
- Primary Explorer API average response changed from N/A ms to 523.5 ms: N/A.

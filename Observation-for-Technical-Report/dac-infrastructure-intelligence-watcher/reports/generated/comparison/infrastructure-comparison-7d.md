...
|---|---|
| Snapshot count | 7 |
| Observation index range | 38 -> 44 |
| First checked at UTC | 2026-06-13T18:57:21.166839+00:00 |
...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 3, HEALTHY: 3, UNHEALTHY: 1 | DEGRADED: 2, HEALTHY: 4, UNHEALTHY: 1 | 2043.57 ms | 1531.29 ms | IMPROVED |
| explorer_web | HEALTHY: 7 | HEALTHY: 7 | 589.57 ms | 734.86 ms | WORSENED |
| primary_explorer_api | HEALTHY: 7 | HEALTHY: 7 | 433.29 ms | 561.14 ms | WORSENED |
...
|---|---|---|---:|---:|
| official_public_rpc | FAST: 1, MODERATE: 1, SLOW: 5 | FAST: 1, MODERATE: 2, SLOW: 4 | 4780.0 ms | 4632.0 ms |
| explorer_web | FAST: 2, MODERATE: 5 | FAST: 1, MODERATE: 6 | 825.0 ms | 1246.0 ms |
| primary_explorer_api | FAST: 6, MODERATE: 1 | FAST: 2, MODERATE: 5 | 623.0 ms | 1157.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.6929 to 0.7571: IMPROVED.
- Official Public RPC average response changed from 2043.57 ms to 1531.29 ms: IMPROVED.
- Explorer Web average response changed from 589.57 ms to 734.86 ms: WORSENED.
- Primary Explorer API average response changed from 433.29 ms to 561.14 ms: WORSENED.

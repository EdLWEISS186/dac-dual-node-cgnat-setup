...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 4, HEALTHY: 4 | DEGRADED: 3, HEALTHY: 3, UNHEALTHY: 2 | 4850.12 ms | 12407.62 ms | WORSENED |
| explorer_web | HEALTHY: 8 | HEALTHY: 8 | 610.25 ms | 609.75 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 8 | HEALTHY: 8 | 475.62 ms | 483.75 ms | WORSENED |
...
| primary_explorer_api | FAST: 4, MODERATE: 4 | FAST: 4, MODERATE: 4 | 811.0 ms | 942.0 ms |

## 4. Interpretation

- Overall availability score changed from 0.775 to 0.6313: WORSENED.
- Official Public RPC average response changed from 4850.12 ms to 12407.62 ms: WORSENED.
- Explorer Web average response changed from 610.25 ms to 609.75 ms: IMPROVED.
- Primary Explorer API average response changed from 475.62 ms to 483.75 ms: WORSENED.

...
|---|---|
| Snapshot count | 7 |
| Observation index range | 46 -> 52 |
| First checked at UTC | 2026-06-18T14:34:01.163762+00:00 |
...
|---|---|---|---:|---:|---|
| official_public_rpc | DEGRADED: 2, HEALTHY: 3, UNHEALTHY: 1 | DEGRADED: 4, HEALTHY: 3 | 3621.17 ms | 4830.57 ms | WORSENED |
| explorer_web | HEALTHY: 6 | HEALTHY: 7 | 690.17 ms | 612.29 ms | IMPROVED |
| primary_explorer_api | HEALTHY: 6 | HEALTHY: 7 | 486.83 ms | 471.29 ms | IMPROVED |
...
|---|---|---|---:|---:|
| official_public_rpc | MODERATE: 2, SLOW: 4 | FAST: 1, MODERATE: 2, SLOW: 4 | 15809.0 ms | 20946.0 ms |
...
- Overall availability score changed from 0.7167 to 0.7429: IMPROVED.
- Official Public RPC average response changed from 3621.17 ms to 4830.57 ms: WORSENED.
- Explorer Web average response changed from 690.17 ms to 612.29 ms: IMPROVED.
- Primary Explorer API average response changed from 486.83 ms to 471.29 ms: IMPROVED.
